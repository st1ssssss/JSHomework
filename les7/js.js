...
const walls = {
    ...
    createWall() {
        this.setCoordinates(game.getRandomFreeCoordinates());
    },
...
const game = {
    ...
    setScore() {
        ...
        this.scoreDiv.insertAdjacentHTML('beforeend', this.createScore())
    },

    createScore() {
        return `<p class="snakeScore">Ваш счет: ${this.snake.getBody().length - 1}</p>`
    },
    ...
    reset() {
        ...
        this.walls.setCoordinates(this.getRandomFreeCoordinates())
        this.render();
    },

    render() {
        this.map.render(this.snake.body, this.food.getCoordinates(), this.walls.getCoordinates());
    ...
    getRandomFreeCoordinates() {
        const exclude = [this.food.getCoordinates(), ...this.snake.getBody(), this.walls.getCoordinates()];
    ...
    tickHandler() {
        ...
        if (this.walls.isOnPoint(this.snake.getNextHeadPoint())) {
            return this.finish()
        }
